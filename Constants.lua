--local PityMe = LibStub("AceAddon-3.0"):GetAddon("PityMe")
...
PityMe.bosses = {
          ...
          --Raid Bosses
          102672,106087,105393,100497,102679,104636,103769, -- EN
          114263,114344,114537, -- ToV
          102263,101002,104415,104288,103758,105503,110965,107699,104528,103685, -- NH
